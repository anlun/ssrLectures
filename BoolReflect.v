...
Proof.
rewrite /prime_spec /discr_prime => n.
...
move=> HP; case; simpl.
  - move=> p2.
    ...
    split; intuition.
  move=> HP'.
  constructor; case; move=> H3; intuition.
Qed.

Lemma xorP (b1 b2 : bool): reflect (XOR b1 b2) (xorb b1 b2).
Proof.
case b1; case b2; constructor; rewrite /XOR; intuition.
Qed.
...
Proof.
unfold XOR'; unfold XOR; intuition.
Qed.
...
Lemma xorP' (b1 b2 : bool): reflect (XOR' b1 b2) (xorb b1 b2).
Proof.
Search _ (_ <-> _) (reflect _  _).
exact: equivP _ _ _ (xorP b1 b2) (XORequiv _ _).
Qed.
...
Proof.
Search _ (reflect _ _) (_ <-> _).
move: (xorP b1 b2).
move: (xorP b2 b1).
rewrite /XOR.
case b1; case b2; simpl; constructor; constructor; intuition.
Qed.
